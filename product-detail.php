...
<div class="container my-5">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <ul class="nav custom-product-tabs mb-4 justify-content-center" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#description">Description</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#reviews">Customer Reviews</a>
                </li>
            </ul>

            <div class="tab-content custom-tab-content p-4 border rounded">
                <!-- Description Tab -->

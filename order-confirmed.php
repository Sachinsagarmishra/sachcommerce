            ...
            <div class="col-lg-10">
                ...
                <?php if ($guest_password && $guest_email): ?>
                    ...
                    <div class="guest-account-alert">
                        ...
                        <p>We've created an account for you so you can track your order. Your login credentials have been
                        ...
                        <p class="mt-3 mb-0"><small>Please save these credentials and change your password after first
                                login.</small></p>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="order-body">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-item-value"><?php echo $estimated_delivery_start; ?> -
                                    <?php echo $estimated_delivery_end; ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mt-4">
                                ...
                                <?php if ($order['discount_amount'] > 0): ?>
                                    <div class="order-summary-row">
                                        <span>Discount</span>
                                        <span
                                            class="text-success">-<?php echo format_price($order['discount_amount']); ?></span>
                                    </div>
                                <?php endif; ?>

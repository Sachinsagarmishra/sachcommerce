...
<div class="container my-5">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <?php if ($item['stock_quantity'] < $item['quantity']): ?>
                                                    <small class="text-danger">Only <?php echo $item['stock_quantity']; ?> left in stock</small>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <button class="btn btn-link text-danger remove-from-cart-btn" data-cart-id="<?php echo $item['id']; ?>">
            ...
            <!-- Continue Shopping -->
            <div class="mt-3">
                <a href="<?php echo SITE_URL; ?>/shop.php" class="btn btn-outline-primary">

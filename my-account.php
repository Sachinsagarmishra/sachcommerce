        ...
        <div class="col-lg-3 mb-4">
            <div class="card">
                <div class="card-body text-center">
                    <div class="mb-3">
                        <?php if ($user['avatar']): ?>
                            <img src="<?php echo AVATAR_IMAGE_URL . $user['avatar']; ?>" class="rounded-circle" width="80" height="80" alt="<?php echo htmlspecialchars($user['name']); ?>">
                        <?php else: ?>
            ...
            <div class="list-group mt-3">
                <a href="<?php echo SITE_URL; ?>/my-account.php" class="list-group-item list-group-item-action active">
                ...
                <a href="<?php echo SITE_URL; ?>/addresses.php" class="list-group-item list-group-item-action">
                    <i class="fas fa-map-marker-alt me-2"></i>Addresses
                </a>
                <a href="<?php echo SITE_URL; ?>/profile-edit.php" class="list-group-item list-group-item-action">
                    <i class="fas fa-user-edit me-2"></i>Edit Profile
                </a>
                <a href="<?php echo SITE_URL; ?>/change-password.php" class="list-group-item list-group-item-action">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo SITE_URL; ?>/order-detail.php?order=<?php echo $order['order_number']; ?>" class="btn btn-sm btn-outline-primary">View</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <div class="text-center py-4">
                        ...
                        <a href="<?php echo SITE_URL; ?>/shop.php" class="btn btn-primary">Start Shopping</a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>

...
<footer class="admin-footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <p class="mb-0">&copy; <?php echo date('Y'); ?> <?php echo get_site_setting('site_name', SITE_NAME); ?>.
                    All rights reserved.</p>
            </div>
            <div class="col-md-6 text-end">
                <p class="mb-0">crafted by <a href="https://sachindesign.com/" target="_blank"
                        class="text-decoration-none text-muted">sachin sagar</a></p>
            </div>
        </div>
    </div>
</footer>

                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-success">
                                <i class="fas fa-revenue fa-3x"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="orders.php" class="btn btn-info">
                                <i class="fas fa-cart"></i> View Orders
                            </a>
                            <a href="add-coupon.php" class="btn btn-success">
                                <i class="fas fa-ticket"></i> Create Coupon
                            </a>
            ...
            <div class="col-lg-8 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-cart"></i> Recent Orders</span>

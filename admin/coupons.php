                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control text-uppercase" name="code"
                                    value="<?php echo htmlspecialchars($c_code); ?>" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="status">
                                    <option value="active" <?php echo $c_stat === 'active' ? 'selected' : ''; ?>>Active
                                    </option>
                                    <option value="inactive" <?php echo $c_stat === 'inactive' ? 'selected' : ''; ?>>Inactive
                                    </option>
                                    <option value="expired" <?php echo $c_stat === 'expired' ? 'selected' : ''; ?>>Expired
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" name="description"
                                    rows="2"><?php echo htmlspecialchars($c_desc); ?></textarea>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" name="discount_type" id="discount_type">
                                    <option value="percentage" <?php echo $c_type === 'percentage' ? 'selected' : ''; ?>>
                                        Percentage (%)</option>
                                    <option value="fixed" <?php echo $c_type === 'fixed' ? 'selected' : ''; ?>>Fixed Amount
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">
                                <i
                                    class="fas fa-save me-2"></i><?php echo $action === 'edit' ? 'Update Coupon' : 'Create Coupon'; ?>
                            </button>
                                ...
                                <?php foreach ($coupons as $coupon): ?>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small
                                                class="text-muted"><?php echo htmlspecialchars(substr($coupon['description'], 0, 30)) . (strlen($coupon['description']) > 30 ? '...' : ''); ?></small>
                                        </td>
                                        <td>
                                            <?php if ($coupon['discount_type'] === 'percentage'): ?>
                                                <span class="badge bg-info text-dark"><?php echo $coupon['discount_value']; ?>%
                                                    OFF</span>
                                            ...
                                            <?php else: ?>
                                                <span
                                                    class="badge bg-success"><?php echo format_price($coupon['discount_value']); ?>
                                                    OFF</span>
                                            <?php endif; ?>
                                        </td>
